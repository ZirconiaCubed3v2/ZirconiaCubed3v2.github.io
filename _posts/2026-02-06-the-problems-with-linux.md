...
<br><br>
Another often misinterpreted term is 'distribution' or the shortened 'distro'. A Linux distro is simply a set of configurations and extra packages stacked on top of a root version of Linux, such as Debian, Arch, Red Hat, NixOS, etc.
<br><br>
...
<br><br>
Benchmarks against CachyOS are showing that, but 'faster' is a bit subjective. Sure, it goes faster, but in most use cases and to most users, it's so insignificant that it wouldn't be much of a loss to go with another distro instead.
...
<br><br>
In some situations, CachyOS did indeed edge ahead by 1-3 FPS, but that could be considered test error, especially when the numbers were >100. Does that mean CachyOS lied? Absolutely not. Their optimizations do improve performance, but it's such a small bump most average users wouldn't notice.
